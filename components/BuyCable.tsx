...
const CABLE_PLANS: Record<string, any[]> = {
  ...
  "1": [
    ...
    { id: "gotv-max", title: "GOtv Max", price: "7,200", duration: "1 Month" },
    {
      id: "gotv-supa",
      title: "GOtv Supa",
      price: "9,600",
...
export default function BuyCablePage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://aigsolution.com.ng/app/api/cabletv/verify/index.php",
        {
          method: "POST",
          headers: {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const session = JSON.parse(raw || "{}");
      const response = await fetch(
        "https://aigsolution.com.ng/app/api/cabletv/index.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
